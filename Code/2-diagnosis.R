...
## on analyzing the abnormal observations or the distribution of
## residuals. The analysis helps us better understand the data set 
## and brings us information on model selection.
##
## (Additional Details)
...
# overall feeling of the data
summary(data1)

# linear model
lm1 = lm(energy ~ pir+age+gender+I(age^2)+I(age^3)+pregnancy
         +num_people_hd+num_people_fm, weight = w, data = data1)
